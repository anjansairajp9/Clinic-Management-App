...
type Props = {
	...
	loading: boolean;
	onEdit: (treatment: TreatmentDetails) => void;
					...
					<div style={scrollableContentStyle}>
						{loading ? (
							...
							<>
								...
								>
									...
									<InfoCard
										...
										items={[
											...
											[
												"Complaint",
												treatment.appointment_complaint || "-",
											],
										]}
									/>
								...
								{treatment && (
									<TreatmentFilesSection treatmentId={treatment.id} />
								)}
...
function ActionButton({ icon, label, styleType, onClick, isMobile }: any) {
