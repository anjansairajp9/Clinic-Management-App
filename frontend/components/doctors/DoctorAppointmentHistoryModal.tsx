...
export default function DoctorAppointmentHistoryModal({
  ...
  return (
    <>
      {/* CSS injected to handle smooth hover states and custom calendar icon colors */}
      <style>{`
        .hover-card {
        ...
        >
          ...
          <div
            style={{
              ...
              marginBottom:
                "28px",
              flexShrink: 0, // Prevents filter from collapsing
            }}
          >
            <input
              type="date"
          ...
          {/* Content (Now includes Pagination at the bottom) */}
          <div
            style={{
              display:
                "flex",
              ...
              minHeight: 0, // Crucial for flex scrolling to work
              overflowY:
                "auto",
              paddingRight:
                "8px",
          ...
          >
            ...
            {/* Pagination (Moved inside the scrollable content) */}
            <div
              style={{
                display:
                  "flex",
                ...
                alignItems: 
                  "center",
                marginTop:
                  "10px", // Re-adjusted gap 
                marginBottom: 
                  "10px", // Breathes better at the bottom
                flexShrink: 0,
              }}
            >
              <button
